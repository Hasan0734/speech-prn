...
const Modal = ({ open, modalHandler, children, maxWidth='max-w-lg' }) => {
  return (
    <>
      <Transition appear show={open}>
        ...
        >
          <div className='min-h-screen px-4 text-center'>
            ...
            >
              <div className={`inline-block w-full ${maxWidth} my-8 overflow-hidden align-middle transition-all transform`}>
